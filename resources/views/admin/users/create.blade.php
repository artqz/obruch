...
{{ Form::open(['url' => 'admin/users', 'method' => 'put']) }}
    ...
    <div class="form-group">
        ...
        <small id="loginHelp" class="text-danger">{{ $errors->first('rang') }}</small>
    </div>
    <div class="form-group">
        ...
        <small id="loginHelp" class="text-danger">{{ $errors->first('email') }}</small>
    </div>
    <div class="form-group">
        ...
        <small id="loginHelp" class="text-danger">{{ $errors->first('name') }}</small>
    </div>
    <div class="form-group">
        ...
        <small id="loginHelp" class="text-danger">{{ $errors->first('birthdate') }}</small>
    </div>
    <div class="form-group">
        ...
        <small id="loginHelp" class="text-danger">{{ $errors->first('password') }}</small>
    </div>
    <div class="form-group">
        ...
        <small id="loginHelp" class="text-danger">{{ $errors->first('photo') }}</small>
    </div>
